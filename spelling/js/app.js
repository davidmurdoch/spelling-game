...
const _words = [
  ...
  ["native", "I am a native of this city."],
  ["office", "I work in an office."],

  ["practice", "I need to practice my piano."],
  ["relative", "I have many relatives."],
  ["positive", "I am positive that I will win."],
  ["lettuce", "I like lettuce on my sandwich."],

  ["expensive", "This car is very expensive."],
  ["tortoise", "The tortoise is slow."],
  ["sensitive", "My skin is sensitive to the sun."],
];
...
// fade background color when it changes
