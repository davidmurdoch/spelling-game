...
const _words = [
  ["define", "This birthday will define my character for life."],
  ["neighbor", "I didn't invite my neighbor to my birthday party."],
  ["numeral", "The roman numeral for 10 is X."],
  ["poster", "Should I put up a poster for my birthday party?"],
  ["costume", "You will wear a star wars costume at the party."],
  ["explain", "I will explain the house rules to my friends."],
  ["approach", "If you approach the pool, you must jump in."],
  ["desire", "I have a desire to have fun."],
  ["bracelet", "We might make bracelets."],
  ["pursue", "I will pursue happiness."],
  ["trombone", "Do not play the sad trombone at the party."],
  ["survive", "If you survive the party, you will ive to see another day."],
  ["refrain", "Refrain from crying, please."],
  ["rotate", "Rotate in the float until you get dizzy."],
  ["reduce", "Reduce the volume of your screaming or my daddy will kick you out."],
  ["recite", "We wil not recite the national anthem at the party."],
  ["clothe", "You must clothe yourselves in fine garments."],
  ["perfume", "The pool water will wash out your perfume."],
  ["divine", "Jump in, the water feels divine!"],
  ["maintain", "I cannot maintain this handstand forever, or I will drown."],
  ["attach", "Do not attach yourself to the garden gnome."],
  ["success", "Operation birthday party was a success."],
  ["deliver", "Should we deliver the pizza to the pizza pizza?"],
  ["proverb", "We had the word proverb last week."],
  ["result", "The result of the things was the problem."],
];
