...
const _words = [
  ["weave", "We will weave the basket."],
  ["receive", "I will receive the package."],
  ["marine", "The marine is in the ocean."],
  ["yield", "The yield is the amount of crops."],
  ["redeem", "I will redeem the coupon."],
  ["receipt", "I will give you the receipt."],
  ["either", "I will either go to the store or the park."],
  ["seedling", "The seedling is a small plant."],
  ["retrieve", "I will retrieve the ball."],
  ["seize", "I will seize the opportunity."],
  ["repeat", "I will repeat the sentence."],
  ["gasoline", "The gasoline is in the car."],
  ["neither", "I will neither go to the store nor the park."],
  ["increase", "I will increase the volume."],
  ["diesel", "The diesel is in the truck."],
  ["routine", "I will do my routine."],
