...
const _words = [
  ["jewel", "There is not a jewel in their goody bags"],
  ["loyal", "My friends are loyal"],
  ["chowder", "We are not having chowder at my birthday party"],
  ["awesome", "My birthday party is going to be awesome"],
  ["cocoon", "There might be a cocoon in my backyard"],
  ["hoist", "We might have to hostLuke over the fence to get the frisbee"],
  ["applaud", "Gigi will probably applaud when I open her gift"],
  ["rejoice", "I rejoice every time I open a gift"],
  ["pronounce", "Its hard to pronounce some of the words on my friends cards"],
  ["saucer", "My friends are not fancy enough for a cup and saucer."],
  ["soothe", "I soothe my sunburn with aloe"],
  ["caution", "Throw caution to the wind; its my birthday!"],
  ["coupon", "There is not a coupon at my birthday party"],
  ["bassoon", "I do not have a bassoon at my party"],
  ["auction", "There will not be an auction at my party"],
  ["voyage", "My birthday is a voyage"],
  ["cougar", "I hope I get a cougar for my birthday"],
  ["steward", "My mom is the steward of my birthday party"],
  ["destroy", "WE will destroy the cake"],
  ["awkward", "It is awkward when I open a gift and I don't know what to say"],
  ["repeat", ""],
  ["yield", ""],
  ["either", ""],
  ["receive", ""],
