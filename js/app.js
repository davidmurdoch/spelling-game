...
const _words = [
  ["furnish", "The house was furnished with new furniture."],
  ["cashier", "The cashier at the grocery store rang up my groceries."],
  ["weary", "I was weary after a long day at work."],
  ["purpose", "The purpose of the meeting was to discuss the budget."],
  ["rehearse", "The actors will rehearse their lines before the play."],
  ["current", "The current is strong in the river."],
  ["concern", "I have a concern about the safety of the bridge."],
  ["nourish", "The mother bird will nourish her young."],
  ["alert", "The police officer was on alert for speeding cars."],
  ["volunteer", "The volunteer helped the elderly lady cross the street."],
  ["deserve", "I don't deserve to be treated this way."],
  ["murmur", "The baby will murmur when he is hungry."],
  ["virtue", "The virtue of honesty is important."],
  ["further", "The students will further their education by going to college."],
  ["reverse", "The car was in reverse when it hit the tree."],
  ["flourish", "The garden will flourish with the rain."],
  ["observe", "The scientist will observe the animals in their natural habitat."],
  ["courtesy", "The courtesy of the waiter was appreciated."],
  // ["herbal", "The herbal tea will help you feel better."],
  // ["frontier", "The frontier of the country is vast."],
  // ["loyal", "The loyal dog will protect his owner."],
  // ["pronounce", "The teacher will pronounce the word correctly."],
  // ["jewel", "The jewel was stolen from the museum."],
  // ["caution", "The driver was cautious on the icy road."],
  // ["voyage", "The voyage to the moon will take a long time."],
];
